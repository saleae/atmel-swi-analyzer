...
SWI_PacketParam PacketParams[] = {
    ...
    // TempSense
    { SWIO_TempSense, true, "TempSense", 1, 0, PT_Opcode },
    { SWIO_TempSense, true, "Zero1", 1, 0, PT_Byte },
    { SWIO_TempSense, true, "Zero2", 2, 0, PT_Word },

    { SWIO_TempSense, false, "Temp", 4, 0, PT_DWord },

    // Info
    { SWIO_Info, true, "INFO", 1, 0, PT_Opcode },
    { SWIO_Info, true, "Mode", 1, 0, PT_Byte },
    { SWIO_Info, true, "Param", 2, 0, PT_Word },

    { SWIO_Info, false, "Response", 4, 0, PT_DWord },

    // Verify
    // Possible Counts for a packet with Verify:
    //	32+32+19+7=90, 36+36+19+7=98, 32+32+0+7=71, 36+36+0+7=79, 32+32+32+32+7=135, 36+36+36+36+7=151
    // Ordered: 71, 79, 90, 98, 135, 151

    { SWIO_Verify, true, "Verify", 1, 0, PT_Opcode },
    { SWIO_Verify, true, "Mode", 1, 0, PT_Byte },
    { SWIO_Verify, true, "KeyID", 2, 0, PT_Word },

    // all byte counts possible while using data1 with 32bytes
    { SWIO_Verify, true, "Data1", 32, 71, PT_RawBytes },
    { SWIO_Verify, true, "Data1", 32, 90, PT_RawBytes },
    { SWIO_Verify, true, "Data1", 32, 135, PT_RawBytes },

    // all byte counts possible while using data1 with 64bytes
    { SWIO_Verify, true, "Data1", 36, 79, PT_RawBytes },
    { SWIO_Verify, true, "Data1", 36, 98, PT_RawBytes },
    { SWIO_Verify, true, "Data1", 36, 151, PT_RawBytes },

    // all byte counts possible while using data2 with 32bytes
    { SWIO_Verify, true, "Data2", 32, 71, PT_RawBytes },
    { SWIO_Verify, true, "Data2", 32, 90, PT_RawBytes },
    { SWIO_Verify, true, "Data2", 32, 135, PT_RawBytes },

    // all byte counts possible while using data2 with 64bytes
    { SWIO_Verify, true, "Data2", 36, 79, PT_RawBytes },
    { SWIO_Verify, true, "Data2", 36, 98, PT_RawBytes },
    { SWIO_Verify, true, "Data2", 36, 151, PT_RawBytes },

    // all byte counts possible while using data3
    { SWIO_Verify, true, "Data3", 32, 135, PT_RawBytes },
    { SWIO_Verify, true, "Data3", 36, 151, PT_RawBytes },

    // all byte counts possible while using OtherData
    { SWIO_Verify, true, "OtherData", 19, 79, PT_RawBytes },

    { SWIO_Verify, false, "Response", 1, 0, PT_Byte },

    // Sign
    { SWIO_Sign, true, "Sign", 1, 0, PT_Opcode },
    { SWIO_Sign, true, "Mode", 1, 0, PT_Byte },
    { SWIO_Sign, true, "KeyID", 2, 0, PT_Word },

    { SWIO_Sign, false, "Response", 64, 67, PT_RawBytes },
    { SWIO_Sign, false, "Response", 72, 75, PT_RawBytes },

    // GenKey
    { SWIO_GenKey, true, "GenKey", 1, 0, PT_Opcode },
    { SWIO_GenKey, true, "Mode", 1, 0, PT_Byte },
    { SWIO_GenKey, true, "KeyID", 2, 0, PT_Word },
    { SWIO_GenKey, true, "OtherData", 3, 10, PT_RawBytes },

    { SWIO_GenKey, false, "Reponse", 1, 4, PT_Byte },
    { SWIO_GenKey, false, "Reponse", 64, 67, PT_RawBytes },
    { SWIO_GenKey, false, "Reponse", 72, 75, PT_RawBytes },
...
SWI_WaveParser::SWI_WaveParser( AnalyzerChannelData* pChannel, U64 sampleRateHz )
    : SampleDur_ns( 1e9 / sampleRateHz ), mSDA( pChannel ), BuffLastElem( 0 )
{
}
